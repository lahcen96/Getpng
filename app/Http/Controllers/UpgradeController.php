...
class UpgradeController extends Controller
{
 ...
 private static function moveDirectory($directory, $destination, $copy)
 {
	...
	public function update($version)
	{
		...
		$CONTROLLERS_AUTH = app_path('Http/Controllers/Auth/');
		$TRAITS = app_path('Http/Controllers/Traits/');
		...
		$VIEWS_ADMIN = resource_path('views/admin/');
		$VIEWS_AJAX = resource_path('views/ajax/');
		$VIEWS_AUTH = resource_path('views/auth/');
		$VIEWS_DASHBOARD = resource_path('views/dashboard/');
		$VIEWS_DEFAULT = resource_path('views/default/');
		$VIEWS_EMAILS = resource_path('views/emails/');
		$VIEWS_ERRORS = resource_path('views/errors/');
		$VIEWS_IMAGES = resource_path('views/images/');
		$VIEWS_INCLUDES = resource_path('views/includes/');
		$VIEWS_INDEX = resource_path('views/index/');
		$VIEWS_LAYOUTS = resource_path('views/layouts/');
		$VIEWS_PAGES = resource_path('views/pages/');
		$VIEWS_USERS = resource_path('views/users/');
